                ...
                <div class="p-6 text-gray-900">
					...
					<form action = "{{ route('articles.store') }}" method = "post">  
						...
						<div class="field my-2">
							...
							<input type = "text" value="{{ old('title') }}" name = "title" class = "border-gray-300 p-2">
						...
						<div class="field my-2" >
							...
							<textarea name = "summary" cols = "30" rows = "2" class = "border-gray-300 p-2" >{{ old('summary') }}</textarea>

						</div>

						<div class="field my-2">
							<lable for=""> {{__("開始時間")}} </lable>
							<input type = "date" value="{{ old('start_time') }}" name = "start_time" class = "border-gray-300 p-2">

						</div>

						<div class="field my-2">
							<lable for=""> {{__("結束時間")}} </lable>
							<input type = "date" value="{{ old('end_time') }}" name = "end_time" class = "border-gray-300 p-2">
						...
						<div class="flex">
							...
							<a href = "{{route('articles.index')}}"> 取消新增 </a>
						</div>
					</form>
                </form>
                </div>
